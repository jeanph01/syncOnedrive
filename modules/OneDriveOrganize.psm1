...
function Get-TargetRoot {
    ...
    try {
        # Règles déclaratives
        $Rules = @(
            @{ Name="CoffreFort-Michelle"; Patterns=@("Pour coffre fort/Michelle"); Action="Move"; TargetRoot="Pour coffre fort/Michelle"; Priority=1 },
            @{ Name="CoffreFort-Relations"; Patterns=@("Pour coffre fort/relations"); Action="Move"; TargetRoot="Pour coffre fort/relations"; Priority=1 },
            @{ Name="CoffreFort-Archives"; Patterns=@("Pour coffre fort/archives"); Action="Move"; TargetRoot="Pour coffre fort/archives"; Priority=1 },
...
function Get-DestinationPath {
    ...
    try {
        ...
        if ($FileMeta.p -match "^/drive/root:/VersCoffreFort/archives") {
            $rawDestination = "/VersCoffreFort/archives/$Category/Pellicule/$($FileDate.Year)/$($FileDate.ToString('MM'))"
        ...
        # ============================================================
        # RÈGLE STAY (et seulement Stay) : limiter à 3 niveaux
        # ============================================================
        if ($Category -eq "Stay") {
